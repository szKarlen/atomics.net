namespace System.Threading.Atomics
{
    ...
    public enum MemoryOrder : int
    {
        ...
        /// </summary>
        [Obsolete("Does not have any effect. DEC Alpha alike architectures are not supported")]
        Consume,
        ...
        /// </summary>
        /// <remarks>Current atomics implementation does use only <see cref="AcqRel"/> semantics. Usage of this flag falls back to <see cref="AcqRel"/></remarks>
        Acquire,
        ...
        /// </summary>
        /// <remarks>Default behavior for <see cref="Atomic{T}"/>, excluding <see cref="AtomicInteger"/>, <see cref="AtomicLong"/>, <see cref="AtomicBoolean"/> and <see cref="AtomicReference{T}"/>, which are using <see cref="AcqRel"/> semantics</remarks>
        SeqCst
    }
}
